...
const AllModelsTab = ({
  ...
  const teamOptions = useMemo(
    () => [
      { value: PERSONAL_TEAM_VALUE, label: t("pages.allModelsTab.personal", { defaultValue: "Personal" }) },
      ...(teams ?? [])
  ...
  const handleDeleteModel = async () => {
    ...
    try {
      ...
      toast.success(t("pages.allModelsTab.modelDeletedSuccess", { defaultValue: "Model deleted successfully" }));
  ...
  const handleTogglePause = useCallback(
    async (modelId: string, blocked: boolean) => {
      ...
      try {
        ...
        toast.success(
          blocked
            ? t("pages.allModelsTab.modelPaused", { defaultValue: "Model paused" })
            : t("pages.allModelsTab.modelResumed", { defaultValue: "Model resumed" }),
        );
  ...
  return (
    <div className="w-full">
            ...
            {selectedTeamValue === PERSONAL_TEAM_VALUE ? (
              <span>
                ...
                <a href={uiHref("api-keys")} className="font-medium text-info hover:underline">
                  {t("pages.allModelsTab.virtualKeysPageLink", { defaultValue: "Virtual Keys page" })}
                </a>
                .
              </span>
            ) : (
      ...
      <DeleteResourceModal
        ...
        title={t("pages.allModelsTab.deleteModelTitle", { defaultValue: "Delete Model" })}
        alertMessage={t("pages.allModelsTab.deleteAlertMessage", { defaultValue: "This action cannot be undone." })}
        message={t("pages.allModelsTab.deleteMessage", {
          defaultValue: "Are you sure you want to delete this model?",
        })}
        resourceInformationTitle={t("pages.allModelsTab.modelInformation", { defaultValue: "Model Information" })}
        resourceInformation={
          modelToDelete
            ? [
                {
                  label: t("pages.allModelsTab.modelName", { defaultValue: "Model Name" }),
                  value: modelToDelete.model_name || t("pages.allModelsTab.notSet", { defaultValue: "Not Set" }),
                },
                {
                  label: t("pages.allModelsTab.litellmModelName", { defaultValue: "LiteLLM Model Name" }),
                  value:
                    modelToDelete.litellm_model_name || t("pages.allModelsTab.notSet", { defaultValue: "Not Set" }),
                },
                {
                  label: t("pages.allModelsTab.provider", { defaultValue: "Provider" }),
                  value: modelToDelete.provider || t("pages.allModelsTab.notSet", { defaultValue: "Not Set" }),
                },
                {
                  label: t("pages.allModelsTab.createdBy", { defaultValue: "Created By" }),
                  value:
                    modelToDelete.model_info?.created_by || t("pages.allModelsTab.notSet", { defaultValue: "Not Set" }),
                },
              ]
            : []
        }
