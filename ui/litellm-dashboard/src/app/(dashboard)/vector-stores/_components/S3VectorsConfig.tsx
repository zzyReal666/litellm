...
const S3VectorsConfig: React.FC<S3VectorsConfigProps> = ({ accessToken, providerParams, onParamsChange }) => {
  ...
  const bucketNameError =
    bucketName && bucketName.length < 3
      ? t("vectorStoreManagement.s3VectorsConfig.bucketNameHelp", {
          defaultValue: "Bucket name must be at least 3 characters",
        })
      : undefined;
  const indexNameError =
    indexName && indexName.length > 0 && indexName.length < 3
      ? t("vectorStoreManagement.createVectorStore.indexNameMinLength", {
  ...
  return (
    <TooltipProvider>
      <Alert variant="info" className="mb-4">
        <Info />
        <AlertTitle>
          {t("vectorStoreManagement.s3VectorsConfig.alertTitle", { defaultValue: "AWS S3 Vectors Setup" })}
        </AlertTitle>
        <AlertDescription>
          <div>
            <p>
              {t("vectorStores.s3VectorsConfig.intro", {
                defaultValue: "AWS S3 Vectors allows you to store and query vector embeddings directly in S3:",
              })}
            </p>
            <ul style={{ marginLeft: "16px", marginTop: "8px" }}>
              <li>
                {t("vectorStoreManagement.s3VectorsConfig.alertItem1", {
                  defaultValue: "Vector buckets and indexes will be automatically created if they don't exist",
                })}
              </li>
              <li>
                {t("vectorStoreManagement.s3VectorsConfig.alertItem2", {
                  defaultValue: "Vector dimensions are auto-detected from your selected embedding model",
                })}
              </li>
              <li>
                {t("vectorStoreManagement.s3VectorsConfig.alertItem3", {
                  defaultValue: "Ensure your AWS credentials have permissions for S3 Vectors operations",
                })}
              </li>
              <li>
                {t("vectorStoreManagement.s3VectorsConfig.alertItem4Prefix", { defaultValue: "Learn more:" })}{" "}
                <a
                ...
                >
                  {t("vectorStoreManagement.s3VectorsConfig.alertItem4Link", {
                    defaultValue: "AWS S3 Vectors Documentation",
                  })}
                </a>
              </li>
            </ul>
      ...
      <Field data-invalid={bucketNameError !== undefined || undefined}>
        <FieldLabel htmlFor="s3-vector-bucket-name">
          {labelWithHint(
            t("vectorStoreManagement.s3VectorsConfig.vectorBucketNameLabel", { defaultValue: "Vector Bucket Name" }),
            t("vectorStoreManagement.s3VectorsConfig.vectorBucketNameTooltip", {
              defaultValue:
        ...
        <Input
          ...
          placeholder={t("vectorStoreManagement.s3VectorsConfig.vectorBucketNamePlaceholder", {
            defaultValue: "my-vector-bucket (min 3 chars)",
          })}
      ...
      <Field data-invalid={indexNameError !== undefined || undefined}>
        <FieldLabel htmlFor="s3-index-name">
          {labelWithHint(
            t("vectorStoreManagement.s3VectorsConfig.indexNameLabel", { defaultValue: "Index Name" }),
            t("vectorStoreManagement.s3VectorsConfig.indexNameTooltip", {
              defaultValue:
        ...
        <Input
          ...
          placeholder={t("vectorStoreManagement.s3VectorsConfig.indexNamePlaceholder", {
            defaultValue: "my-vector-index (optional, min 3 chars)",
          })}
      ...
      <Field>
        <FieldLabel htmlFor="s3-aws-region-name">
          {labelWithHint(
            t("vectorStoreManagement.s3VectorsConfig.awsRegionLabel", { defaultValue: "AWS Region" }),
            t("vectorStoreManagement.s3VectorsConfig.awsRegionTooltip", {
              defaultValue: "AWS region where the S3 bucket is located (e.g., us-west-2)",
            }),
          )}
        </FieldLabel>
        <Input
      ...
      <Field>
        <FieldLabel htmlFor="s3-embedding-model">
          {labelWithHint(
            t("vectorStoreManagement.s3VectorsConfig.embeddingModelLabel", { defaultValue: "Embedding Model" }),
            t("vectorStoreManagement.s3VectorsConfig.embeddingModelTooltip", {
              defaultValue: "Select the embedding model to use for vector generation",
            }),
          )}
        </FieldLabel>
        <Combobox
          ...
          <ComboboxContent>
            <ComboboxEmpty>
              {isLoadingModels
                ...
                : t("vectorStores.s3VectorsConfig.noEmbeddingModels", { defaultValue: "No embedding models found." })}
            </ComboboxEmpty>
            <ComboboxList>
              {(model: string) => (
