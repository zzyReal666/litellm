  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">
        {t("vectorStores.documentsTable.noDocumentsYet", { defaultValue: "No documents uploaded yet" })}
      </div>
      <div className="text-sm text-muted-foreground">
        {t("vectorStores.documentsTable.uploadHint", { defaultValue: "Upload documents above to get started." })}
      </div>
    </div>
  );
}
