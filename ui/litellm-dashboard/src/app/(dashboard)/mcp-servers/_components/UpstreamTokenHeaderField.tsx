  ...
  return (
    <MountedFormField
      label={
        <span className="text-sm font-medium text-foreground flex items-center">
          {t("mcpTools.upstreamTokenHeaderField.label", { defaultValue: "Token Header (optional)" })}
          <SimpleTooltip
            content={t("mcpTools.upstreamTokenHeaderField.tooltip", {
              defaultValue:
    ...
    >
      {(control) => (
        <Input
          {...textControl(control)}
          placeholder={t("mcpTools.upstreamTokenHeaderField.placeholder", { defaultValue: "Authorization" })}
