      ...
      <div>
        <div className="mb-2 flex items-center gap-2">
          <span className="text-sm font-medium">
            {t("mcpTools.mcpLogoSelector.logoLabel", { defaultValue: "Logo" })}
          </span>
          <Tooltip>
            <TooltipTrigger
              render={
                <Info
                  ...
                  aria-label={t("mcpTools.mcpLogoSelector.logoLabel", { defaultValue: "Logo" })}
                />
              }
            />
            <TooltipContent>
              {t("mcpTools.mcpLogoSelector.logoTooltip", {
                defaultValue:
        ...
        {value && (
          <div className="mb-3 flex items-center gap-3 rounded-lg border border-border bg-muted p-3">
            <Logo
              ...
              label={t("mcpTools.mcpLogoSelector.selectedLogoLabel", { defaultValue: "Selected" })}
        ...
        <InputGroup>
          ...
          <InputGroupInput
            placeholder={t("mcpTools.mcpLogoSelector.customUrlPlaceholder", {
              defaultValue: "Or paste a custom logo URL...",
            })}
