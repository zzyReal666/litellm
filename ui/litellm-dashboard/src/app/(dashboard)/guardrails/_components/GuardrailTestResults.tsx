  ...
  return (
    <div className="space-y-3 border-t border-border pt-4">
      <h3 className="text-sm font-semibold">
        {t("guardrails.guardrailTestResults.resultsHeading", { defaultValue: "Results" })}
      </h3>
                    ...
                    {!isCollapsed && (
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          if (success) {
                            toast.success(
                              t("guardrails.guardrailTestResults.resultCopied", {
                                defaultValue: "Result copied to clipboard",
                              }),
                            );
                          } else {
                            toast.fromError(
                              t("guardrails.guardrailTestResults.failedToCopyResult", {
                                defaultValue: "Failed to copy result",
                              }),
                            );
                          }
                        }}
                  ...
                  <>
                    <div className="rounded-sm border border-success/20 bg-background p-3">
                      <label className="mb-2 block text-xs font-medium text-muted-foreground">
                        {t("guardrails.guardrailTestResults.outputText", { defaultValue: "Output Text" })}
                      </label>
                    ...
                    <div className="text-xs text-muted-foreground">
                      <span className="font-medium">
                        {t("guardrails.guardrailTestResults.characters", { defaultValue: "Characters:" })}
                      </span>{" "}
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="flex-1">
                    <div className="mb-1 flex items-center justify-between">
                      ...
                      >
                        {t("guardrails.guardrailTestResults.errorTitle", {
                          name: errorItem.guardrailName,
