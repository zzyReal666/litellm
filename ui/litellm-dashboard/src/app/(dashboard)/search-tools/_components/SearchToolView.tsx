    ...
    <div className="p-4 max-w-full">
      <div className="flex justify-between items-center mb-6">
        <div>
          <Button variant="ghost" size="sm" className="mb-4 -ml-2 text-muted-foreground" onClick={onBack}>
            ...
            {t("searchTools.searchToolView.backToAll", { defaultValue: "Back to All Search Tools" })}
          </Button>
          <div className="flex items-center gap-1">
            ...
            <Button
              variant="ghost"
              size="icon-xs"
              aria-label={t("searchTools.searchToolView.copyName", { defaultValue: "Copy search tool name" })}
          ...
          <div className="flex items-center gap-1">
            ...
            <Button
              variant="ghost"
              size="icon-xs"
              aria-label={t("searchTools.searchToolView.copyId", { defaultValue: "Copy search tool ID" })}
              className="text-muted-foreground"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              {t("searchTools.searchToolView.providerLabel", { defaultValue: "Provider" })}
            </p>
        ...
        <Card>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              {t("searchTools.searchToolView.apiKeyLabel", { defaultValue: "API Key" })}
            </p>
            <p className="mt-2 text-foreground">
              {searchTool.litellm_params.api_key
                ? "****"
                : t("searchTools.searchToolView.notSet", { defaultValue: "Not set" })}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              {t("guardrails.guardrailInfo.createdAt", { defaultValue: "Created At" })}
            </p>
            <p className="mt-2 text-foreground">
      ...
      {searchTool.search_tool_info?.description && (
        <Card className="mt-6">
          <CardContent>
            <p className="text-sm text-muted-foreground">{t("common.description", { defaultValue: "Description" })}</p>
