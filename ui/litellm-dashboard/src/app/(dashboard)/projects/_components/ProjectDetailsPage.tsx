    ...
    return (
      <div className="p-6 px-12">
        ...
        <p className="py-8 text-center text-sm text-muted-foreground">
          {t("projects.projectDetailsPage.notFound", { defaultValue: "Project not found" })}
        </p>
      </div>
    );
  }
    ...
    <div className="p-6 px-12">
      <div className="mb-6 flex items-center justify-between">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <StatusBadge
                ...
                label={
                  project.blocked
                    ? t("projects.projectDetailsPage.statusBlocked", { defaultValue: "Blocked" })
            ...
            <div className="flex items-center gap-1 text-sm text-muted-foreground">
              <span>
                {t("projects.projectDetailsPage.id", { defaultValue: "ID:" })} {project.project_id}
              </span>
              <CopyButton
                value={project.project_id}
                label={t("projects.projectDetailsPage.copyProjectId", { defaultValue: "Copy project ID" })}
              />
            </div>
          </div>
        </div>
        <Button onClick={() => setIsEditModalVisible(true)}>
          ...
          {t("projects.projectDetailsPage.editProject", { defaultValue: "Edit Project" })}
        </Button>
      </div>

      <Card className="mb-6">
        <CardHeader>
          <CardTitle>{t("projects.projectDetailsPage.detailsTitle", { defaultValue: "Project Details" })}</CardTitle>
        </CardHeader>
        <CardContent>
          <dl className="grid grid-cols-[max-content_1fr] gap-x-4 gap-y-2 text-sm">
            ...
            <dt className="text-muted-foreground">{t("oldTeams.columns.created", { defaultValue: "Created" })}</dt>
            <dd className="flex items-center gap-1 text-foreground">
              {new Date(project.created_at).toLocaleString()}
              {project.created_by && (
                <>
                  <span>{t("projects.projectDetailsPage.by", { defaultValue: "by" })}</span>
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Card className="h-full">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t("projects.projectDetailsPage.budgetTitle", { defaultValue: "Budget" })}
            </CardTitle>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                {hasLimit
                  ? t("projects.projectDetailsPage.budgetOf", {
                      budget: maxBudget.toFixed(2),
                      defaultValue: "of ${{budget}} budget",
                    })
                  : t("projects.projectDetailsPage.noBudgetLimit", { defaultValue: "No budget limit" })}
              </p>
            </div>
            {hasLimit && (
              <div>
        ...
        <Card className="h-full lg:col-span-2">
          <CardHeader>
            <CardTitle>{t("projects.projectDetailsPage.spendByModel", { defaultValue: "Spend by Model" })}</CardTitle>
          </CardHeader>
          <CardContent>
            {modelSpendData.length > 0 ? (
              ...
              <p className="py-8 text-center text-sm text-muted-foreground">
                {t("projects.projectDetailsPage.noModelSpend", { defaultValue: "No model spend recorded yet" })}
              </p>
            )}
          </CardContent>
        </Card>
        ...
        <Card className="h-full">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t("projects.projectDetailsPage.teamTitle", { defaultValue: "Team" })}
            </CardTitle>
          </CardHeader>
          <CardContent>
            {teamInfo ? (
                  ...
                  <div className="flex flex-col gap-3">
                    <div>
                      ...
                      <div className="flex items-center gap-1 text-xs text-muted-foreground">
                        <span>
                          {t("projects.projectDetailsPage.id", { defaultValue: "ID:" })} {teamInfo.team_id}
                        </span>
                        <CopyButton
                          value={teamInfo.team_id}
                          label={t("teamPage.teamsTable.copyTeamId", { defaultValue: "Copy team ID" })}
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      <p className="mb-1 text-xs text-muted-foreground">
                        {t("projects.projectDetailsPage.modelsLabel", { defaultValue: "Models" })}
                      </p>
                      {(teamInfo.models?.length ?? 0) > 0 ? (
                        ...
                        <p className="text-sm text-muted-foreground">
                          {t("projects.projectDetailsPage.allModels", { defaultValue: "All models" })}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      <div className="mb-0.5 flex items-center justify-between">
                        <span className="text-xs text-muted-foreground">
                          {t("projects.projectDetailsPage.spendLabel", { defaultValue: "Spend" })}
                        </span>
                        <span className="text-xs text-foreground">
                          ...
                          <span className="text-muted-foreground">
                            {teamHasLimit
                              ...
                              : ` (${t("projects.projectDetailsPage.unlimited", { defaultValue: "Unlimited" })})`}
                          </span>
                        </span>
                      </div>
                      {teamHasLimit && (
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-muted-foreground">
                        {t("projects.projectDetailsPage.membersLabel", { defaultValue: "Members" })}
                      </span>
              ...
              <div
                role="status"
                aria-busy="true"
                aria-label={t("projects.projectDetailsPage.loadingTeam", { defaultValue: "Loading team" })}
              ...
              <p className="py-8 text-center text-sm text-muted-foreground">
                {t("projects.projectDetailsPage.noTeamAssigned", { defaultValue: "No team assigned" })}
              </p>
            )}
          </CardContent>
        </Card>
