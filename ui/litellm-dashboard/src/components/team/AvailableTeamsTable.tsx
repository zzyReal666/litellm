  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">
        {t("teamPage.availableTeams.emptyTitle", { defaultValue: "No available teams to join" })}
      </div>
      <div className="text-sm text-muted-foreground">
        <Trans
          i18nKey="teamPage.availableTeams.emptyHint"
          defaults="See how to set available teams <lnk>here</lnk>"
          components={{
            lnk: (
              <a
...
const AvailableTeamsTable: React.FC<AvailableTeamsTableProps> = ({ teams, isLoading, onJoinTeam }) => {
  ...
  return (
    <DataTable
      ...
      isLoading={isLoading}
      loadingMessage={t("teamPage.availableTeams.loadingTeams", { defaultValue: "Loading available teams…" })}
