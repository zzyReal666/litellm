    ...
    <div className="mx-auto mt-8 max-w-2xl rounded-lg border border-dashed border-border bg-card p-12 text-center">
      <div className="flex flex-col items-center gap-2">
        ...
        <h4 className="text-base font-semibold">
          {t("cloudZero.cloudZeroEmptyPlaceholder.title", { defaultValue: "No CloudZero Integration Found" })}
        </h4>
        ...
        <Button size="lg" onClick={startCreation} className="mt-4">
          {t("cloudZero.cloudZeroEmptyPlaceholder.addButton", { defaultValue: "Add CloudZero Integration" })}
        </Button>
      </div>
    </div>
  );
