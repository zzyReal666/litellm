    ...
    <div className="mt-2 space-y-1">
      <div className="flex items-center gap-1">
        <span className="text-xs font-medium text-muted-foreground">
          {t("addModel.tierModelEffort.reasoningEffortLabel", { defaultValue: "Reasoning effort" })}
        </span>
        <SimpleTooltip
          content={t("addModel.tierModelEffort.reasoningEffortTooltip", {
            defaultValue:
        ...
        <div key={model} className="flex items-center justify-between gap-2">
          ...
          >
            <SelectTrigger
              size="sm"
              className="w-36"
              aria-label={t("addModel.tierModelEffort.reasoningEffortAriaLabel", {
                defaultValue: "Reasoning effort for {{model}} in the {{tier}} tier",
                model,
                tier: tierLabel,
              })}
            >
