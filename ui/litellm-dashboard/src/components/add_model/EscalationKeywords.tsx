    ...
    <div className="w-full max-w-none">
      <div className="flex items-center gap-2 mb-1">
        <h4 className="m-0 text-xl font-semibold text-foreground">
          {t("addModel.escalationKeywords.title", { defaultValue: "Escalation Keywords" })}
        </h4>
        <SimpleTooltip
          content={t("addModel.escalationKeywords.tooltip", {
            defaultValue:
      ...
      <span className="mb-2 block text-xs text-muted-foreground">
        {t("addModel.escalationKeywords.description", {
          defaultValue:
      ...
      <MultiSelect
        ...
        emptyText={t("addModel.escalationKeywords.emptyText", { defaultValue: "Type to add a phrase" })}
        allowCustomValues
        className="w-full"
      />
    </div>
