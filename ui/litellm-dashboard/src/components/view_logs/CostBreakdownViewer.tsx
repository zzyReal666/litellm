        ...
        <CollapsibleTrigger className="flex w-full items-center gap-3 px-4 py-3 text-left">
          ...
          <div className="flex items-center justify-between w-full">
            <h3 className="text-lg font-medium text-foreground">
              {t("viewLogs.costBreakdownViewer.title", { defaultValue: "Cost Breakdown" })}
            </h3>
            <div className="flex items-center space-x-2 mr-4">
              <span className="text-sm text-muted-foreground">
                {t("viewLogs.costBreakdownViewer.totalLabel", { defaultValue: "Total:" })}
              </span>
              <span className="text-sm font-semibold text-foreground">
                {formatCost(totalSpend)}
                {isCached && ` (${t("viewLogs.costBreakdownViewer.cached", { defaultValue: "Cached" })})`}
              </span>
            </div>
          </div>
        </CollapsibleTrigger>
        <CollapsibleContent>
          <div className="p-6 space-y-4">
            ...
            <div className="space-y-2 max-w-2xl">
                    ...
                    <>
                      <div className="flex text-sm">
                        <span className="text-muted-foreground font-medium w-1/3">
                          {t("viewLogs.costBreakdownViewer.inputCostLabel", { defaultValue: "Input Cost:" })}
                        </span>
                        <span className="text-foreground">
                          {formatCost(rawCost)}
                          {rawInputTokens !== undefined && rawInputTokens !== null && (
                            <span className="text-muted-foreground font-normal ml-1">
                              {t("viewLogs.costBreakdownViewer.tokenCount", {
                                count: rawInputTokens.toLocaleString(),
                                defaultValue: `(${rawInputTokens.toLocaleString()} tokens)`,
                              })}
                            </span>
                          )}
                        </span>
                      ...
                      {(costBreakdown?.cache_read_cost ?? 0) > 0 && (
                        <div className="flex text-sm">
                          <span className="text-muted-foreground font-medium w-1/3">
                            {t("viewLogs.costBreakdownViewer.cacheReadCostLabel", {
                              defaultValue: "Prompt Cache Read Cost:",
                            })}
                          </span>
                          <span className="text-foreground">
                            ...
                            {(cacheReadTokens ?? 0) > 0 && (
                              <span className="text-muted-foreground font-normal ml-1">
                                {t("viewLogs.costBreakdownViewer.tokenCount", {
                                  count: (cacheReadTokens ?? 0).toLocaleString(),
                                  defaultValue: `(${(cacheReadTokens ?? 0).toLocaleString()} tokens)`,
                                })}
                              </span>
                            )}
                          </span>
                      ...
                      {(costBreakdown?.cache_creation_cost ?? 0) > 0 && (
                        <div className="flex text-sm">
                          <span className="text-muted-foreground font-medium w-1/3">
                            {t("viewLogs.costBreakdownViewer.cacheWriteCostLabel", {
                              defaultValue: "Prompt Cache Write Cost:",
                            })}
                          </span>
                          <span className="text-foreground">
                            ...
                            {(cacheCreationTokens ?? 0) > 0 && (
                              <span className="text-muted-foreground font-normal ml-1">
                                {t("viewLogs.costBreakdownViewer.tokenCount", {
                                  count: (cacheCreationTokens ?? 0).toLocaleString(),
                                  defaultValue: `(${(cacheCreationTokens ?? 0).toLocaleString()} tokens)`,
                                })}
                              </span>
                            )}
                          </span>
                  ...
                  <div className="flex text-sm">
                    ...
                    <span className="text-foreground">
                      ...
                      {promptTokens !== undefined && (
                        <span className="text-muted-foreground font-normal ml-1">
                          {t("viewLogs.costBreakdownViewer.promptTokenCount", {
                            count: promptTokens.toLocaleString(),
                            defaultValue: `(${promptTokens.toLocaleString()} prompt tokens)`,
                          })}
                        </span>
                      )}
                    </span>
              ...
              <div className="flex text-sm">
                <span className="text-muted-foreground font-medium w-1/3">
                  {t("viewLogs.costBreakdownViewer.outputCostLabel", { defaultValue: "Output Cost:" })}
                </span>
                <span className="text-foreground">
                  {formatCost(outputCost)}
                  {completionTokens !== undefined && (
                    <span className="text-muted-foreground font-normal ml-1">
                      {t("viewLogs.costBreakdownViewer.completionTokenCount", {
                        count: completionTokens.toLocaleString(),
                        defaultValue: `(${completionTokens.toLocaleString()} completion tokens)`,
                      })}
                    </span>
                  )}
                </span>
              ...
              {costBreakdown?.tool_usage_cost !== undefined && costBreakdown.tool_usage_cost > 0 && (
                <div className="flex text-sm">
                  <span className="text-muted-foreground font-medium w-1/3">
                    {t("viewLogs.costBreakdownViewer.toolUsageCostLabel", { defaultValue: "Tool Usage Cost:" })}
                  </span>
            ...
            {!isCached && (
              <div className="pt-2 border-t border-border max-w-2xl">
                <div className="flex text-sm font-semibold">
                  <span className="text-foreground w-1/3">
                    {t("viewLogs.costBreakdownViewer.originalLlmCostLabel", { defaultValue: "Original LLM Cost:" })}
                  </span>
                ...
                {hasDiscount && (
                  <div className="space-y-2">
                    {costBreakdown.discount_percent !== undefined && costBreakdown.discount_percent !== 0 && (
                      <div className="flex text-sm text-muted-foreground">
                        <span className="font-medium w-1/3">
                          {t("viewLogs.costBreakdownViewer.discountLabel", {
                            percent: formatPercent(costBreakdown.discount_percent),
                            defaultValue: `Discount (${formatPercent(costBreakdown.discount_percent)}):`,
                          })}
                        </span>
                    ...
                    {costBreakdown.discount_amount !== undefined && costBreakdown.discount_percent === undefined && (
                      <div className="flex text-sm text-muted-foreground">
                        <span className="font-medium w-1/3">
                          {t("viewLogs.costBreakdownViewer.discountAmountLabel", { defaultValue: "Discount Amount:" })}
                        </span>
                        <span className="text-foreground">-{formatCost(costBreakdown.discount_amount)}</span>
                      </div>
                    )}
                ...
                {hasMargin && (
                  <div className="space-y-2">
                    {costBreakdown.margin_percent !== undefined && costBreakdown.margin_percent !== 0 && (
                      <div className="flex text-sm text-muted-foreground">
                        <span className="font-medium w-1/3">
                          {t("viewLogs.costBreakdownViewer.marginLabel", {
                            percent: formatPercent(costBreakdown.margin_percent),
                            defaultValue: `Margin (${formatPercent(costBreakdown.margin_percent)}):`,
                          })}
                        </span>
                        <span className="text-foreground">
                          +
                    ...
                    {costBreakdown.margin_fixed_amount !== undefined && costBreakdown.margin_fixed_amount !== 0 && (
                      <div className="flex text-sm text-muted-foreground">
                        <span className="font-medium w-1/3">
                          {t("viewLogs.costBreakdownViewer.marginFixedLabel", { defaultValue: "Margin:" })}
                        </span>
            ...
            <div className="mt-4 pt-4 border-t border-border max-w-2xl">
              <div className="flex items-center">
                <span className="font-bold text-sm text-foreground w-1/3">
                  {t("viewLogs.costBreakdownViewer.finalCalculatedCostLabel", {
                    defaultValue: "Final Calculated Cost:",
                  })}
                </span>
